...
function arrowFromTrend(trend: string): { arrow: string; cls: string } {
  if (trend === 'rising' || trend === 'softening') return { arrow: '↑', cls: 'arrow good' }
  if (trend === 'falling' || trend === 'tightening') return { arrow: '↓', cls: 'arrow bad' }
